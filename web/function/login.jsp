...
<html lang="vi">
    <head>
        ...
        <title>Đăng nhập - DigiBook</title>
            ...
            <div class="auth-card">
                ...
                <form method="post" action="${pageContext.request.contextPath}/login" novalidate>
                    <div class="form-group">
                        <label for="identifier">Email trường/Mã sinh viên <span class="required-asterisk">*</span></label>
                        <input type="text" id="identifier" name="identifier" placeholder="email@example.com hoặc username" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-row">
                        ...
                        <a class="link" href="${pageContext.request.contextPath}/register">Chưa có tài khoản? Đăng ký</a>
                    </div>
